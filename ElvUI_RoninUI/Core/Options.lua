...
local function configTable()
	...
	Details.args.Profile1Button = ACH:Execute(Engine.ProfileData.Details.Profile1ButtonText, 'This will import the Details profile.', 4, function() SetupProfileButton('Details', 'Profile1', UpdateCurrentProfileHeder) end, nil, nil, 'full')
